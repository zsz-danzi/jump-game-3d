	...
	Man.prototype.jump = function(){
		...
		if(!this.first_flag){
			...
			console.log(  this.target_s1 , this.target_s2 )

			// console.log( this.t )
		}

		// console.log( this.time, this.t )
		...
		console.log( this.man.position.y , this.man.position.x )
